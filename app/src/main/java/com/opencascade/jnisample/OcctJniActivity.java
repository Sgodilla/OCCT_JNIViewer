  ...
  public void onClick (View theButton)
  {
    ...
    switch (aClickedBtn.getId())
    {
      ...
      case R.id.open:
      {
        ...
        if (partFile == null)
        {
          askUserPermission (Manifest.permission.MANAGE_EXTERNAL_STORAGE, null); // for accessing SD card

          if(mStoragePermissionGranted)
          {
            new ChooserDialog(OcctJniActivity.this)
                    ...
                    .withChosenListener(new ChooserDialog.Result() {
                      ...
                      public void onChoosePath(String path, File pathFile) {
                        partFile = pathFile;
                        myOcctView.open (partFile.getPath());
                        Toast.makeText(OcctJniActivity.this, "FILE: " + path, Toast.LENGTH_SHORT).show();
                      }
                    })
                    // to handle the back key pressed or clicked outside the dialog:
                    .withOnCancelListener(new DialogInterface.OnCancelListener() {
                      public void onCancel(DialogInterface dialog) {
                        aClickedBtn.setBackgroundColor (getResources().getColor(R.color.btnColor));
                        Log.d("CANCEL", "CANCEL");
        ...
        /*if (myFileOpenDialog == null)
        {
          ...
          askUserPermission (Manifest.permission.READ_EXTERNAL_STORAGE, null); // for accessing SD card
